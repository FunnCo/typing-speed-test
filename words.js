...
function getDictionary({ language = 'ru', difficulty = 'beginner' } = {}) {
  ...
  if (lang === 'en') return diff === 'pro' ? enTopWords : enBasicWords;
  return diff === 'pro' ? ruTopWords : ruBasicWords;
}

export function randomWords({ language = 'ru', difficulty = 'beginner', count = 40 } = {}) {
...
export const WordGenerator = { randomWords };
if (typeof window !== 'undefined') window.WordGenerator = WordGenerator;